...
public class SelecionarGerenciamento extends javax.swing.JFrame {
    ...
    public SelecionarGerenciamento(String nomeDoUsuario) {
        ...
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
					...
					//Essa parte, será registrada no log.
				}
            }
        });

        jButton1.setBackground(new java.awt.Color(254, 253, 79));
        jButton1.setText("Gerenciamento de usuários");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gerenciarUsuarios(evt);
            }
        });

        jButton2.setBackground(new java.awt.Color(254, 253, 79));
        jButton2.setText("Gerenciamento de encomendas");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gerenciarEncomendas(evt);
            }
        });
    ...
    private void gerenciarUsuarios(java.awt.event.ActionEvent evt) {
        setVisible(false);
        (new MenuUsuario(nomeDoUsuario)).setVisible(true);
    }

    private void gerenciarEncomendas(java.awt.event.ActionEvent evt) {
        setVisible(false);
        (new MenuEncomenda(nomeDoUsuario)).setVisible(true);
    }

    private void deslogar(java.awt.event.ActionEvent evt) throws Exception {
        setVisible(false);
